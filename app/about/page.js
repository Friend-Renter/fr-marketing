    ...
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <header className="text-center">
        ...
        <p className="mt-1 text-brand-700">
          Real profiles. Host approval. Clear protection. Built by friends, for friends.
        </p>
      </header>
        ...
        <div className="grid items-center gap-8 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-3 space-y-4 text-gray-700">
              <p>
                FriendRenter exists to make sharing vehicles between friends simple, secure,
                and genuinely fun. We’re building a platform where trust is part of the booking
                flow—real profiles, host approval, and clear protection—so people can rent to
                their circle with peace of mind.
              </p>
              <p>
                We want to empower owners to be their own boss and build real businesses—keeping
                money in the community instead of sending it to traditional rental counters. And for
                renters, we want access to cool, unique vehicles you won’t find elsewhere, with a
                smooth, mobile-first experience.
              </p>
              <p>
                At our core, we’re about community: bookings happen between friends. Add → accept → book.
              </p>
            </div>
          </div>
          ...
          <div className="relative mx-auto w-full max-w-xl">
            <div className="overflow-hidden rounded-xl ring-1 ring-gray-200 shadow-sm">
              <Image
                src="/brand/about-mission.jpg" // TODO: replace with your asset
      ...
      <section id="principles" className="mt-12">
        <h2 className="text-2xl font-semibold text-gray-900">What We Stand For</h2>
        <div className="mt-4 space-y-6 text-gray-700">
          <p>
            <span className="font-semibold text-gray-900">Trust Built In.</span>{" "}
            Approvals, verification, and photo check-in/out aren’t add-ons—they’re part of
            how booking works. That creates a clear, transparent paper trail that respects
            both sides.
          </p>
          <p>
            <span className="font-semibold text-gray-900">Owner Control, Community Value.</span>{" "}
            Hosts decide daily rates, deposits, and minimum renter age. Earnings stay within
            your circle and community, not with a counter line and upsell desk.
          </p>
          <p>
            <span className="font-semibold text-gray-900">Simple, Mobile, Respectful.</span>{" "}
            Everything lives in the app: requests, approvals, photos, and receipts. It’s a
            friendlier way to find and drive unique vehicles—with real accountability.
          </p>
        </div>
      </section>
      ...
      <section id="team" className="mt-12">
        ...
        <p className="mt-2 text-gray-700">
          A small team with builder energy—focused on trust, good design, and real-world utility.
        </p>
      ...
      <section id="cta" className="mt-12">
        <div className="rounded-md bg-brand-50 p-5">
          <h2 className="text-lg font-semibold text-brand-900">Join early access</h2>
