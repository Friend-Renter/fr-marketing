    ...
    <div className="">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-2 ">
          {/* Renters */}
          <div className="rounded-lg border border-gray-200 bg-white py-8 pl-10 px-6 shadow-card bg-gradient-to-br from-brand-50 to-zinc-50">
          ...
          <div
            id="become-host"
            className="rounded-lg border border-gray-200 bg-white pl-10 py-8 px-6 shadow-card bg-gradient-to-br from-brand-50 to-zinc-50"
          >
            <h3 className="text-2xl font-semibold tracking-tight text-brand-900">
              Hosts
            </h3>
